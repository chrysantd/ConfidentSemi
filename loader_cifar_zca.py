...
class CIFAR10(data.Dataset):
    ...
    nclass = 10
    split_list = ['label', 'unlabel', 'valid', 'test','label2','unlabel2']

    def __init__(self, root, split='train',
                 transform=None, target_transform=None,
                 download=False, boundary=0, label_data_number = 4000, val_data_number = 5000):
        ...
        if self.split is 'label' or self.split is 'unlabel' or self.split is 'valid' or self.split is 'label2' or self.split is 'unlabel2':
            ...
            if self.split is 'label' or self.split is 'label2':
            ...
            elif self.split is 'unlabel' or self.split is 'unlabel2':
